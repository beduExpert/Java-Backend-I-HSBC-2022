...
3. Cree un POJO simple (clase Java antigua simple) que actuará como nuestro modelo para enviar y recibir mensajes. Aquí hemos usado Lombok para reducir el código repetitivo. Las anotaciones utilizadas son las siguientes:
